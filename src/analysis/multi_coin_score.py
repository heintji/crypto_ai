    ...
    try:
        with conn.cursor() as cur:
            ...
            INSERT INTO public.pending_approvals (
                ...
                dag_van_de_week, uur_utc, rsi_at_entry, atr_at_entry,
                volume_ratio, n_signalen_tegelijk
            ) VALUES (
                %s,%s,%s,%s,'4H',%s,%s,
                %s,'GO',%s,%s,%s,%s,%s,
                %s,%s,%s,%s,
            ...
            """, (
                ...
                prebuy.get("dag_van_de_week"),
                prebuy.get("uur_utc"),
                prebuy.get("rsi_at_entry"),
                prebuy.get("atr_at_entry"),
                prebuy.get("volume_ratio"),
                prebuy.get("n_signalen_tegelijk"),
            ))
        conn.commit()
        ...
        try:
            ...
            prebuy = {
                ...
                "score_details": {
                    ...
                    "rsi_at_entry":     round(rsi_4h, 2) if rsi_4h else None,
                    "atr_at_entry":     round(atr_val, 8) if atr_val else None,
                    "volume_ratio":     round(vol_ratio, 3) if vol_ratio else None,
                    "n_signalen_tegelijk": len(_SESSIE.get("signalen", [])),
                    "dag_van_de_week":  datetime.datetime.utcnow().weekday(),
                    "uur_utc":          datetime.datetime.utcnow().hour,
                },
            }
